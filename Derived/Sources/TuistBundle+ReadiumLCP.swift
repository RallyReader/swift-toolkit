...
/// Since ReadiumLCP is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "Readium_ReadiumLCP"
        ...
        fatalError("unable to find bundle named Readium_ReadiumLCP")
    }()
}
