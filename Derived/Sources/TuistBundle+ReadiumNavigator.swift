...
/// Since ReadiumNavigator is a static framework, the bundle containing the resources is copied into the final product.
    static let module: Bundle = {
        let bundleName = "Readium_ReadiumNavigator"
        ...
        fatalError("unable to find bundle named Readium_ReadiumNavigator")
    }()
}
